...
<div class="content">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div style="border: 1px solid #cccccc;border-radius: 0px 0px 10px 10px">
                    <form role="form" action="/auc" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="billboards_position" value="<?php echo e($billboards_position); ?>">
                        <input type="hidden" name="addtime" value="<?php echo e(date("Y-m-d H:i:s")); ?>">
        ...
        <div class="adfoot">
            想知道当前竞价排名？请点击这里查看<a href="/Auction/showAll/<?php echo e($billboards_position); ?>">[竞价排名]</a>
        </div>
    </div>
</div>
