        ...
        <table id="demo-dt-addrow" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    	<a href="/Admin/Administrator/<?php echo e($val->id); ?>/edit" class="btn btn-xs btn-rounded btn-warning">修改</a>
                        <form action="/Admin/Administrator/<?php echo e($val->id); ?>" method="POST" style="display: inline;" accept-charset="utf-8">
