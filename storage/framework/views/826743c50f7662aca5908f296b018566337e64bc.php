            ...
            <form action="/DosoftWareUpdate" method="post" enctype="multipart/form-data">
                ...
                <div class="lab">
                    ...
                    <div class="section con-right">
                        <div class="article">
                            <div class="item">
                                <img class="icon addImg" onclick="clickImg(this);" src="<?php echo e($SoftwareInfo->cover); ?>" />
                                <input name="cover" type="file" class="upload_input" onchange="change(this)"/>
                                <div class="preBlock">
                                    <img class="preview" alt="" src="<?php echo e($SoftwareInfo->cover); ?>" name="pic" width="100" height="100" />
                                </div>
                ...
                <label class="lab">
                    <span>资源名称：</span>
                    <input type="text" name="softwarename" value="<?php echo e($SoftwareInfo->softwarename); ?>" class="con-right inp">
                </label>
                <label class="lab">
                    <span>资源类型：</span>
                    <select class="con-right inp" name="softwaretype">
                        ...
                        <option value="<?php echo e($vc->id); ?>" <?php if($vc->id == $SoftwareInfo->softwaretype): ?> selected <?php endif; ?>><?php echo e($vc->caty_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <input type="hidden" name="is_status" value="<?php echo e($SoftwareInfo->is_status); ?>">
                    <input type="hidden" name="id" value="<?php echo e($SoftwareInfo->id); ?>">
                </label>
                <!--<label class="lab">-->
                    <!--<span>关键词（tag）：</span>-->
                ...
                <label class="lab">
                    <span>适用平台/系统：</span>
                    <input type="text" name="platform" value="<?php echo e($SoftwareInfo->platform); ?>" class="con-right inp">
                </label>
                <label class="lab">
                    <span>是否免费：</span>
                    <p class="con-right inp" >
                        <input type="radio" value="1" <?php if($SoftwareInfo->charge == 1): ?> checked <?php endif; ?> name="charge"> 是
                        <input type="radio" value="0" <?php if($SoftwareInfo->charge == 0): ?> checked <?php endif; ?> name="charge"> 否
                    </p>
                </label>
                 <div  class="lab">
                    <span>展示效果图：</span>
                    <div class="article con-right">
                        <div class="item">
                            ...
                            <img class="icon addImg" src="<?php echo e($SoftwareInfo->EffectOne); ?>" />
                            <?php else: ?>
                        ...
                        <div class="item">
                            ...
                            <img class="icon addImg" src="<?php echo e($SoftwareInfo->EffectThree); ?>" />
                            <?php else: ?>
                            <img class="icon addImg" src="/Home/images/zanwu.jpg" />
                            <?php endif; ?>
                        </div>
                        <div class="item">
                            ...
                            <img class="icon addImg" src="<?php echo e($SoftwareInfo->EffectTwo); ?>" />
                            <?php else: ?>
                            <img class="icon addImg" src="/Home/images/zanwu.jpg" />
                            <?php endif; ?>
                        </div>
                        <div class="item">
                            ...
                            <img class="icon addImg" src="<?php echo e($SoftwareInfo->EffectFour); ?>" />
                            <?php else: ?>
                            <img class="icon addImg" src="/Home/images/zanwu.jpg" />
                            <?php endif; ?>
                        </div>
                ...
                <label class="lab">
                    <span>资源描述：</span>
                    <textarea class="con-right" name="description" rows="5"><?php echo e($SoftwareInfo->description); ?></textarea>
                </label>
