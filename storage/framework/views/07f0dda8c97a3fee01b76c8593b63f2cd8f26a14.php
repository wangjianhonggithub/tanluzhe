            ...
            <div class="adbox">
                    ...
                    <div class="oneleft">
                        ...
                        <?php $__currentLoopData = $banList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <!-- <a href="/Auction/showAll/{$banList->id}" > -->
                                    <option  value="<?php echo e($banList->billboards_position); ?>" <?php echo e($banList->billboards_position == $id ?  'selected' : ''); ?>><?php echo e($banList->billboards_title); ?></option>
                                <!-- </a> -->
                ...
                <div id="box" class="boxtwo">
                    ...
                    <div class="twocontent">
                        <div class="twoc">
                           <?php echo e($banList->billboards_title); ?>
