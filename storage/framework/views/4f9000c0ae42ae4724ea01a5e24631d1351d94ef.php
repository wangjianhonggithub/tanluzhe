...
<div class="panel">
  ...
  <!-- Panel body -->
  <form id="demo-bv-errorcnt" class="form-horizontal bv-form" action="/Admin/Banner" method="POST" enctype="multipart/form-data" novalidate="novalidate">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <select name="c_id" class="selectpicker col-lg-6" name="pid" data-live-search="true" data-width="100%" tabindex="-98">
                ...
                <option value="<?php echo e($val->id); ?>"><?php echo e($val->nav_name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
            </div>
          </div>
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="description" placeholder="描述" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <!-- <div class="form-group has-feedback">
