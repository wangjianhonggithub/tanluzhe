...
<div class="panel">
  ...
  <!-- Panel body -->
	<form id="demo-bv-errorcnt" class="form-horizontal bv-form" action="/Admin/Information/InformationUp" method="POST" enctype="multipart/form-data" novalidate="novalidate">
	<?php echo e(csrf_field()); ?>

		<input type="hidden" name="id" value="<?php echo e($information->id); ?>">
			...
			<div class="tab-content">
				...
				<div id="demo-tabs-box-1" class="tab-pane fade in active">
					...
					<div class="form-group has-feedback">
						...
						<div class="col-lg-7">
						  <input type="text" class="form-control" name="liuyan" placeholder="留言内容" value="<?php echo e($information->liuyan); ?>" data-bv-field="name">
		...
		<div class="panel-footer clearfix">
			<div class="col-lg-7 col-lg-offset-3">
				<button type="submit" class="btn btn-mint" value="点击创建">点击修改</button>
			</div>
		</div>
	</form>
</div>
