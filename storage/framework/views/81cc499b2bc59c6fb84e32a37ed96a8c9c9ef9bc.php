...
<div class="banner">
    <div class="container">
        ...
        <div class="guang">
            <ul>
                <?php if(isset($AdvImage[21])): ?>
                <li><a href="<?php echo e($AdvImage[21]->billboards_url? $AdvImage[21]->billboards_url : $AdvImage[21]->billboards_default_url); ?>"><img src="<?php echo e($AdvImage[21]->billboards_pic? $AdvImage[21]->billboards_pic : $AdvImage[21]->billboards_default_pic); ?>"></a></li>
                <?php endif; ?>
                <?php if(isset($AdvImage[22])): ?>
                <li><a href="<?php echo e($AdvImage[22]->billboards_url? $AdvImage[22]->billboards_url : $AdvImage[22]->billboards_default_url); ?>"><img src="<?php echo e($AdvImage[22]->billboards_pic? $AdvImage[22]->billboards_pic : $AdvImage[22]->billboards_default_pic); ?>"></a></li>
                <?php endif; ?>
                <?php if(isset($AdvImage[23])): ?>
                <li><a href="<?php echo e($AdvImage[23]->billboards_url? $AdvImage[23]->billboards_url : $AdvImage[23]->billboards_default_url); ?>"><img src="<?php echo e($AdvImage[23]->billboards_pic? $AdvImage[23]->billboards_pic : $AdvImage[23]->billboards_default_pic); ?>"></a></li>
                <?php endif; ?>
                <?php if(isset($AdvImage[25])): ?>
                <li><a href="<?php echo e($AdvImage[25]->billboards_url? $AdvImage[25]->billboards_url : $AdvImage[25]->billboards_default_url); ?>"><img src="<?php echo e($AdvImage[25]->billboards_pic? $AdvImage[25]->billboards_pic : $AdvImage[25]->billboards_default_pic); ?>"></a></li>
                <?php endif; ?>
            </ul>
        </div>
