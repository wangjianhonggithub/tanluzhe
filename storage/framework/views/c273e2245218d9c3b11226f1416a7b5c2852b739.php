                        ...
                        <form action="/DoUserConf" method="post" enctype="multipart/form-data">
                            <div class="lab">
                                ...
                                <div class="section con-right">
                                    <div class="article">
                                        <div class="item">
                                            <img class="icon addImg" onclick="clickImg(this);" src="<?php echo e($User->header_pic); ?>" />
                            ...
                            <label class="lab">
                                <span>昵称</span>
                                <input type="text" name="nickname" value="<?php echo e($User->nickname); ?>" class="inp">
                            </label>
                            <label class="lab">
                                <span>手机号</span>
                                <input type="text" name="mobile" value="<?php echo e($User->mobile); ?>" class="inp" maxlength="11">
                            </label>
                            <label class="lab">
                                <span>邮箱</span>
                                <input type="text" name="email" value="<?php echo e($User->email); ?>" class="inp">
                            </label>
                            <label class="lab">
                                <span>密保问题</span>
                                <select class="inp" name="encrypted">
                                    <?php $__currentLoopData = $Enc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $EncInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($EncInfo->id); ?>" <?php if($EncInfo->id == $User->encrypted): ?> selected <?php endif; ?>><?php echo e($EncInfo->encry); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </label>
                            ...
                            <label class="lab">
                                <span>答案</span>
                                <input type="text" name="answer" value="<?php echo e($User->answer); ?>" class="inp">
                            </label>
