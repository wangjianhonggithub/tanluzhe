        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <table class="table table-bordered .table-hover">
                    ...
                    <tr class="row">
                        <td class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-center"><?php echo e($value->billboards_title); ?></td>
                        <td class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-center fangda">
						<img width="180px" src="<?php echo e($value->billboards_position_desc); ?>">
						</td>
                        <td class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-center">
                            <?php if($value->billboards_etime < time()): ?>
                                <a href="javascript:volid(0);" disabled="true">竞拍结束</a>
                            <?php elseif($value->billboards_stime > time()): ?>
                                <a href="javascript:volid(0);" disabled="true">竞拍未开始</a>
                            <?php else: ?>
                                <a href="/createauc/<?php echo e($value->billboards_position); ?>">选择竞拍</a>
                            <?php endif; ?>
                            ...
                            <!--<a href="/Auction/stcshowAll/<?php echo e($value->billboards_position); ?>">查看排名</a>-->
							<?php if($value->money): ?>
							...
							<br/>
                            <br/>
							<span>截止至<?php echo e(date('Y-m-d H:i',$value->billboards_etime)); ?>停止竞拍</span>
                        </td>
                    </tr>
