...
<div class="panel">
  ...
  <!-- Panel body -->
  <form id="demo-bv-errorcnt" class="form-horizontal bv-form" action="/Admin/Caty/<?php echo e($data->id); ?>" method="POST" novalidate="novalidate">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
         ...
         <!--  <div class="form-group has-feedback">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="caty_name" value="<?php echo e($data->caty_name); ?>" placeholder="分类名称" data-bv-field="name">
