...
<div class="panel">
  ...
  <!-- Panel body -->
  <form id="demo-bv-errorcnt" class="form-horizontal bv-form" action="/Admin/Conf/<?php echo e($Update->id); ?>" method="POST" novalidate="novalidate" enctype="multipart/form-data">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <img src="<?php echo e($Update->logo); ?>" width="120" height="80" alt="">
            </div>
          </div>
          <div class="form-group has-feedback">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <img src="<?php echo e($Update->qr_code); ?>" width="120" height="120" alt="">
            </div>
          </div>
          <div class="form-group has-feedback">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" value="<?php echo e($Update->logo_int); ?>" name="logo_int" placeholder="logo导语(登录,注册)" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" value="<?php echo e($Update->email); ?>" name="email" placeholder="邮箱" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" value="<?php echo e($Update->address); ?>" name="address" placeholder="地址" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" value="<?php echo e($Update->mobile); ?>" name="mobile" placeholder="电话" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" value="<?php echo e($Update->zip_code); ?>" name="zip_code" placeholder="邮编" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <img src="<?php echo e($Update->c_map); ?>" width="150" height="150" alt="">
            </div>
          </div>
          <div class="form-group has-feedback">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="switchboard" value="<?php echo e($Update->switchboard); ?>" placeholder="公司总机电话" data-bv-field="email">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="adv_mobile" value="<?php echo e($Update->adv_mobile); ?>" placeholder="广告服务电话" data-bv-field="email">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="record" value="<?php echo e($Update->record); ?>" placeholder="备案号" data-bv-field="email">
              <i class="form-control-feedback" data-bv-icon-for="email" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
