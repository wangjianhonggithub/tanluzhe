                    ...
                    <table class="table table-bordered .table-hover">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <input type="radio" data-shijian='<?php echo e($list[9]['endTime']); ?>' data-money='<?php echo e($list[9]['money']); ?>' name="select" value="9" <?php echo e($list[9]['shijian'] ==0 ? "disabled='disabled'" :""); ?>/>
                            </td>
                            <td class="text-center">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <input type="radio" data-shijian='<?php echo e($list[28]['endTime']); ?>' data-money='<?php echo e($list[28]['money']); ?>' name="select" value="28" <?php echo e($list[28]['shijian'] ==0 ? "disabled='disabled'" :""); ?>/>
                            </td>
                            <td class="text-center">
