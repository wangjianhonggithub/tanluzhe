    ...
    <div class="container">
        ...
        <div class="con-con">
            ...
            <form action="/DoSoftwareRelease" method="post" enctype="multipart/form-data">
                ...
                <label class="lab">
                    <span>资源名称：</span>
                    <input type="text" name="softwarename" value="{{ old('softwarename') }}" class="con-right inp">
                </label>
                <label class="lab">
                    <span>资源类型：</span>
                    <select class="con-right inp" name="softwaretype">
                        @foreach($CatySoftware as $vc)
                        <option value="{{$vc->id}}">{{$vc->caty_name}}</option>
                        @endforeach
                    </select>
                </label>
                <!--<label class="lab">-->
                ...
                <label class="lab">
                    <span>适用平台/系统：</span>
                    <input type="text" placeholder="Windows all/Windows7/Windows XP/IOS all/Android all....." name="platform" value="{{ old('platform') }}" class="con-right inp">
                </label>
                <label class="lab">
                    <span>是否免费：</span>
                ...
                <label class="lab">
                    <span>资源描述：</span>
                    <textarea class="con-right" name="description" rows="5">{{ old('description') }}</textarea>
                </label>
                <label class="lab">
