...
<div class="content">
    <div class="container">
        ...
        <div class="right">
            ...
            <strong class="col-md-6 col-md-offset-3" style='font-weight: normal; color:green;min-height: 0;font-size: 14px; background: rgba(255,255,255,0.8)'>{{Session::get('info')}}</strong>
            <div class="con-con">
