...
<div class="panel">
  ...
  <!-- Panel body -->
  <form id="demo-bv-errorcnt" class="form-horizontal bv-form" action="/Admin/Column/{{$Update->id}}" method="POST" novalidate="novalidate">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
                 <select class="selectpicker col-lg-6" name="pid" data-live-search="true" data-width="100%" tabindex="-98">
                  ...
                  @foreach ($tree as $val)
                  <option value="{{$val->id}}" <?php if ($val->id == $Update->pid) {
                      echo 'selected';
                  }?>><?php if ($val->lev != 1) {echo str_repeat("&nbsp",4*$val->lev);}?>{{$val->name}}</option>
                  @endforeach
              </select>
            </div>
          </div>
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" value="{{$Update->name}}" name="name" placeholder="Name" data-bv-field="name">
