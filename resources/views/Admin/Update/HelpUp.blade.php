...
<div class="panel">
  ...
  <!-- Panel body -->
  <form id="demo-bv-errorcnt" class="form-horizontal bv-form" action="/Admin/Help/{{$data->id}}" method="POST" novalidate="novalidate">
      ...
      <div class="tab-content">
        ...
        <div id="demo-tabs-box-1" class="tab-pane fade in active">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" value="{{$data->title}}" name="title" placeholder="标题" data-bv-field="name">
           ...
           <div class="form-group has-feedback">
            ...
            <div class="col-lg-7">
              <input type="text" class="form-control" name="description" value="{{$data->description}}" placeholder="描述" data-bv-field="name">
              <i class="form-control-feedback" data-bv-icon-for="name" style="display: none;"></i>
            </div>
          </div>
          <div class="form-group has-feedback">
