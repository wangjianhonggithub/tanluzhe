                ...
                <div class="panel">
                    ...
                    <form class="panel-body form-horizontal form-padding" action="/Admin/billboards/update" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" value="{{$data->billboards_title}}" id="demo-text-input" name="billboards_title" class="form-control" placeholder="广告牌标题">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" value="{{$data->billboards_default_url}}"  class="form-control" placeholder="url" name="billboards_default_url">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <img style="width: 100px" src="{{$data->billboards_default_pic}}" alt="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">广告图片</label>
...
--}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <img style="width: 100px" src="{{$data->billboards_position_desc}}" alt="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">位置简介</label>
						...
						<div class="form-group">
                            ...
                            <input type="date" name="startTime" value="{{date('Y-m-d',$data->billboards_stime)}}">
							<input type="time" name="startDay" value="{{date('H:i',$data->billboards_stime)}}">
                        </div>
						<div class="form-group">
                            <label class="col-md-3 control-label">结束时间</label>
                            <input type="date" name="endTime" value="{{date('Y-m-d',$data->billboards_etime)}}">
							<input type="time" name="endDay" value="{{date('H:i',$data->billboards_etime)}}">
                        </div>

                        <input type="hidden" name="billboards_id" value="{{$data->billboards_id}}">
						
                        <input type="hidden" name="billboards_last_update" value="{{date("Y-m-d H-i-s")}}">
