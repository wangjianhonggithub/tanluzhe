        ...
        <table id="demo-dt-addrow" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    	<a href="/Admin/Nav/{{$val->id}}/edit" class="btn btn-xs btn-rounded btn-warning">修改</a>
                        <form action="/Admin/Nav/{{$val->id}}" method="POST" style="display: inline;" accept-charset="utf-8">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
